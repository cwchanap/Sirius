...
- **Current repo source-art size**: 96×96 pixels, transparent PNG
- **Runtime display size**: scaled to 32×32 world cells by `GridMap.cs`
- **Floor/Wall tiles**: match the current shipped 96×96 terrain convention
- **Stair/Gate tiles**: match the current shipped 96×96 terrain convention
- **Outlines**: Bold black lines for tile definition
- **Colors**: Bright, saturated, area-appropriate palette

### Current Repo References

- Existing floor references: `floor_starting_area.png`, `floor_forest.png`, `floor_cave.png`, `floor_desert.png`, `floor_swamp.png`, `floor_mountain.png`, `floor_dungeon.png`
- Existing transition references: `stair_up.png`, `stair_down.png`
- Existing wall reference: `wall_generic.png`
- Additional reference copies live in `assets/sprites/terrain/original/`
...
| Status | File | Size |
|--------|------|------|
| ✅ exists | `assets/sprites/terrain/floor_starting_area.png` | 96×96 source art |
| ✅ exists | `assets/sprites/terrain/floor_forest.png` | 96×96 source art |
| ✅ exists | `assets/sprites/terrain/floor_cave.png` | 96×96 source art |
| ✅ exists | `assets/sprites/terrain/floor_desert.png` | 96×96 source art |
| ✅ exists | `assets/sprites/terrain/floor_swamp.png` | 96×96 source art |
| ✅ exists | `assets/sprites/terrain/floor_mountain.png` | 96×96 source art |
| ✅ exists | `assets/sprites/terrain/floor_dungeon.png` | 96×96 source art |
| ✅ exists | `assets/sprites/terrain/wall_generic.png` | 96×96 source art |
| ❌ missing | `assets/sprites/terrain/floor_boss_arena.png` | target: 96×96 source art |
